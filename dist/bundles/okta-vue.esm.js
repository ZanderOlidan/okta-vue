...
function install(Vue) {
  ...
  if (!oktaAuth.options.restoreOriginalUri) {
    oktaAuth.options.restoreOriginalUri = function () {
      var _ref2 = _asyncToGenerator( _regeneratorRuntime.mark(function _callee(_, originalUri) {
        var path;
  ...
  var guardSecureRoute = function () {
    var _ref3 = _asyncToGenerator( _regeneratorRuntime.mark(function _callee2(authState) {
...
export { script as LoginCallback, oktaVue as default };
